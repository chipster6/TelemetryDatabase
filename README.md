...
This project is proprietary software with all rights reserved. See the [LICENSE](LICENSE) file for complete terms and restrictions. Unauthorized use, reproduction, or distribution is strictly prohibited.
